<div class="flex h-screen bg-[#F3F4F6] font-sans overflow-hidden">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                    <div class="flex items-center gap-6 mb-8">
                        <div class="w-20 h-20 rounded-full bg-blue-600 flex items-center justify-center text-white text-3xl font-bold border-4 border-white shadow-md overflow-hidden">
            ...
            <div class="lg:col-span-1 space-y-6">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 sticky top-6">
                    ...
                    <p class="text-sm text-gray-500 mb-6">En acceptant, vous vous engagez à assurer ce cours.</p>
                    
                    <div class="space-y-3">
                        <button 
    wire:click="accepter" 
    wire:confirm="Confirmer l'acceptation ?"
    wire:loading.attr="disabled" {{-- Empêche de cliquer 2 fois --}}
    class="w-full py-3 bg-[#1E40AF] hover:bg-blue-800 text-white font-bold rounded-xl shadow-lg shadow-blue-100 transition-all flex justify-center items-center gap-2 relative">
    
    {{-- Ce texte s'affiche quand tout est normal --}}
    ...
    {{-- Ce texte/spinner s'affiche PENDANT l'envoi --}}
    ...
    wire:loading.attr="disabled" {{-- Bloque le bouton pendant le chargement --}}
    ...
    <span wire:loading.remove wire:target="refuser">
        Refuser
    </span>

    {{-- CHARGEMENT (Affiché pendant l'envoi) --}}
    <span wire:loading wire:target="refuser" class="flex items-center gap-2 text-red-500">
        {{-- Spinner Rouge --}}
