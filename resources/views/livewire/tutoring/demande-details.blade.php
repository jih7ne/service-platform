    ...
    <main class="flex-1 overflow-y-auto p-4 sm:p-6 md:p-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
                ...
                <div class="bg-white rounded-2xl p-5 sm:p-6 shadow-sm border border-gray-100">
                    <h3 class="font-bold text-gray-900 mb-4 flex items-center gap-2 text-sm sm:text-base">
                        ...
                        <div class="bg-purple-50 text-purple-800 p-4 sm:p-6 rounded-xl border border-purple-100 flex items-center gap-3 sm:gap-4">
                            ...
                            <p class="font-bold text-base sm:text-lg">Cours en ligne</p>
                        </div>
                    @else
                        <div class="flex items-start gap-3 sm:gap-4">
                            <div class="bg-orange-100 p-2 sm:p-3 rounded-full text-orange-600 flex-shrink-0">
            ...
            <div class="lg:col-span-1 space-y-4 sm:space-y-6">
                ...
                <div class="bg-white rounded-2xl p-5 sm:p-6 shadow-sm border border-gray-100 lg:sticky lg:top-6">
                    <h3 class="font-bold text-gray-900 mb-3 sm:mb-4 text-sm sm:text-base">Action requise</h3>
                    <p class="text-xs sm:text-sm text-gray-500 mb-4 sm:mb-6">En acceptant, vous vous engagez à assurer ce cours. Un email de confirmation sera envoyé.</p>
                    ...
                    <div class="space-y-3">
                        <button 
                            ...
                            class="w-full py-2.5 sm:py-3 bg-[#1E40AF] hover:bg-blue-800 text-white font-bold rounded-xl shadow-lg shadow-blue-100 transition-all flex justify-center items-center gap-2 text-sm sm:text-base">
                            
                            <span wire:loading.remove wire:target="accepter">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                                Accepter la demande
                            </span>
                            <span wire:loading wire:target="accepter">
                                <svg class="animate-spin h-4 h-4 sm:h-5 sm:w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                            </span>
                        </button>
                        ...
                        <button 
                            ...
                            wire:loading.attr="disabled"
                            class="w-full py-2.5 sm:py-3 bg-white border-2 border-gray-200 text-gray-600 hover:border-red-200 hover:text-red-600 font-bold rounded-xl transition-all flex justify-center items-center gap-2 text-sm sm:text-base">
                            <span wire:loading.remove wire:target="refuser">Refuser</span>
                            <span wire:loading wire:target="refuser" class="text-red-600">
                                <svg class="animate-spin h-4 h-4 sm:h-5 sm:w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                            </span>
                        </button>
                    </div>
                    ...
                    <div class="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-100">
                        <p class="text-[10px] sm:text-xs font-bold text-gray-400 uppercase mb-2">Contact</p>
                        <p class="text-xs sm:text-sm font-semibold text-gray-800 flex items-center gap-2 break-all">
