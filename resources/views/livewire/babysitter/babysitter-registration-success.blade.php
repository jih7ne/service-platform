            ...
            <div class="px-8 py-12">
                <div class="text-center mb-10">
                    ...
                    <p class="text-gray-600 max-w-lg mx-auto">
                        Nous avons bien reçu votre dossier. Notre équipe va l'examiner attentivement et vous contactera
                        sous 48h pour vous informer de la suite.
                    </p>
                </div>
                ...
                <div class="bg-gray-50 rounded-xl p-8 mb-8">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start">
                            <div
                                class="flex-shrink-0 w-6 h-6 bg-pink-100 rounded-full flex items-center justify-center mt-0.5">
