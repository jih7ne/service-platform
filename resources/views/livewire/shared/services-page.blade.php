    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid md:grid-cols-3 gap-5">
            ...
            <div class="bg-white rounded-2xl p-5 border border-gray-100 hover:shadow-2xl transition-all duration-300 cursor-pointer group shadow-md">
                ...
                <a href="{{ route('pet-keeping.search-service') }}"
                    class="w-full py-2.5 rounded-lg flex items-center justify-center gap-2 group-hover:gap-3 transition-all text-sm bg-[#C78500] text-white font-bold shadow-md hover:shadow-lg">
                        Découvrir
                        <svg class="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
