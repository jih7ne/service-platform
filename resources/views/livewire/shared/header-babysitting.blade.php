                ...
                @auth
                    @if(auth()->user()->role === 'client')
                        <a href="/mes-demandes" wire:navigate 
                           class="text-sm font-semibold hover:text-[#B82E6E] transition-colors {{ request()->is('mes-demandes') ? 'text-[#B82E6E]' : 'text-gray-700' }}">
                            Mes Demandes
                        </a>
                        <a href="/mes-avis" wire:navigate 
                           class="text-sm font-semibold hover:text-[#B82E6E] transition-colors {{ request()->is('mes-avis') ? 'text-[#B82E6E]' : 'text-gray-700' }}">
                            Mes Avis
                        </a>
                        <a href="/mes-reclamations" wire:navigate 
                           class="text-sm font-semibold hover:text-[#B82E6E] transition-colors {{ request()->is('mes-reclamations') ? 'text-[#B82E6E]' : 'text-gray-700' }}">
                            Mes Réclamations
                        </a>
                    @endif
                @endauth
        ...
        <div class="md:hidden border-t border-gray-100">
            <div class="px-4 pt-2 pb-4 space-y-2">
                ...
                @auth
                    @if(auth()->user()->role === 'client')
                        <a href="/mes-demandes" wire:navigate 
                           class="block px-3 py-2 text-sm font-semibold rounded-lg {{ request()->is('mes-demandes') ? 'bg-[#FCE7F3] text-[#B82E6E]' : 'text-gray-700 hover:bg-gray-50' }}">
                            Mes Demandes
                        </a>
                        <a href="/mes-avis" wire:navigate 
                           class="block px-3 py-2 text-sm font-semibold rounded-lg {{ request()->is('mes-avis') ? 'bg-[#FCE7F3] text-[#B82E6E]' : 'text-gray-700 hover:bg-gray-50' }}">
                            Mes Avis
                        </a>
                        <a href="/mes-reclamations" wire:navigate 
                           class="block px-3 py-2 text-sm font-semibold rounded-lg {{ request()->is('mes-reclamations') ? 'bg-[#FCE7F3] text-[#B82E6E]' : 'text-gray-700 hover:bg-gray-50' }}">
                            Mes Réclamations
                        </a>
                    @endif
                @endauth
