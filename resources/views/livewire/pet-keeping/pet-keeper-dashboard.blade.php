        ...
        <div class="px-6 py-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                                ...
                                <div class="pb-6 {{ !$loop->last ? 'border-b border-gray-100' : '' }}">
                                    <div class="flex items-start justify-between mb-3">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="flex">
                                                @for($i = 1; $i <= 5; $i++)
                                                    <svg class="w-4 h-4 {{ $i <= round($avis->note_moyenne) ? 'text-yellow-400' : 'text-gray-300' }}" fill="currentColor" viewBox="0 0 20 20">
                                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                                    </svg>
                                                @endfor
                                            </div>
                    ...
                    <!-- Quick Feedback Sidebar -->
                    @if(count($feedbacksSidebar) > 0)
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                            <div class="px-6 py-4 border-b border-gray-200">
                                <h2 class="text-lg font-semibold text-gray-900 flex items-center">
                            ...
                            <div class="p-6">
                                <div class="space-y-4">
                                    @foreach($feedbacksSidebar as $feedback)
                                    <div class="p-4 bg-gray-50 rounded-lg">
                                        <div class="flex items-center mb-2">
                                            ...
                                            <span class="text-sm font-semibold text-gray-900">{{ $feedback->prenom }}</span>
                                        </div>
                                        <p class="text-gray-600 text-sm">{{ $feedback->commentaire }}</p>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
